    ...
    >
      ...
      >
        ...
        <Text style={[styles.sectionBody, { color: palette.muted }]}>
          Templates are reference-only. They can prefill intent, but your
          issuer's actual terms always win.
        </Text>
          ...
          {providerTemplates.map((item) => (
            <PressableScale
              ...
              contentStyle={[
                ...
                {
                  backgroundColor:
                    draft.providerTemplateId === item.id
                      ? palette.text
                      : palette.cardAlt,
                  borderColor:
                    draft.providerTemplateId === item.id
        ...
        {template ? (
          ...
          >
            <Text style={[styles.templateTitle, { color: palette.text }]}>
              {template.title}
            </Text>
            <Text style={[styles.templateBody, { color: palette.muted }]}>
              {template.hint}
            </Text>
            <Text style={[styles.templateWarning, { color: palette.warning }]}>
              {template.disclaimer}
            </Text>
          </View>
        ) : null}
        ...
        <View style={styles.toggleRow}>
          <PressableScale
            ...
            contentStyle={[
              styles.toggle,
              {
                backgroundColor: draft.notificationsEnabled
                  ? palette.text
                  : palette.cardAlt,
                borderColor: draft.notificationsEnabled
                  ? palette.text
                  : palette.border,
              },
            ]}
          >
            <Text
              style={[
                styles.toggleLabel,
                {
                  color: draft.notificationsEnabled
                    ? palette.background
                    : palette.text,
                },
              ]}
          ...
          <PressableScale
            onPress={() =>
              update({
                extendedTrackingEnabled: !draft.extendedTrackingEnabled,
              })
            }
            contentStyle={[
              styles.toggle,
              {
                backgroundColor: draft.extendedTrackingEnabled
                  ? palette.text
                  : palette.cardAlt,
                borderColor: draft.extendedTrackingEnabled
                  ? palette.text
                  : palette.border,
              },
            ]}
          >
            <Text
              style={[
                styles.toggleLabel,
                {
                  color: draft.extendedTrackingEnabled
                    ? palette.background
                    : palette.text,
                },
              ]}
        ...
        {draft.extendedTrackingEnabled ? (
          <View style={styles.extendedWrap}>
            ...
            <PressableScale
              onPress={() =>
                update({
                  acknowledgmentAccepted: !draft.acknowledgmentAccepted,
                })
              }
              contentStyle={[
                styles.acknowledgment,
                {
                  backgroundColor: draft.acknowledgmentAccepted
                    ? palette.text
                    : palette.cardAlt,
                  borderColor: draft.acknowledgmentAccepted
                    ? palette.text
                    : palette.border,
                },
              ]}
            >
              <Text
                style={[
                  ...
                  {
                    color: draft.acknowledgmentAccepted
                      ? palette.background
                      : palette.text,
                  },
                ]}
              >
                I understand extended dates are only memory aids and may not
                match issuer policy.
              </Text>
            </PressableScale>
          </View>
      ...
      <PressableScale
        ...
        contentStyle={[
          styles.submit,
          { backgroundColor: palette.text, opacity: isSaving ? 0.75 : 1 },
        ]}
      >
        <Text style={[styles.submitText, { color: palette.background }]}>
