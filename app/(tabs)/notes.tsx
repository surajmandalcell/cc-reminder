    ...
    <ScrollView style={{ backgroundColor: palette.background }} contentContainerStyle={styles.content}>
      ...
      <View style={[styles.composer, { backgroundColor: palette.card, borderColor: palette.border }]}> 
        ...
        <PressableScale
          ...
          disabled={isSaving}
          contentStyle={[styles.saveButton, { backgroundColor: palette.text, opacity: isSaving ? 0.72 : 1 }]}> 
      ...
      {notes.map((note) => (
        <View
          ...
          <PressableScale
            ...
            contentStyle={[styles.deleteButton, { backgroundColor: palette.cardAlt, borderColor: palette.border }]}> 
